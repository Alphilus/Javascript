...
public interface PersonDAO {
    void printListPeople(List<Person> people);
    ...
    List<String> findSortedJobs(); //Lấy danh sách tất cả nghề nghiệp đã được sắp xếp từ A-Z

    List<String> findSortedCities(); //Lấy danh sách tất cả thành phố đã được sắp xếp từ A-Z
